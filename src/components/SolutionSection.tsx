    ...
    <section className="py-16 md:py-24 lg:py-32 bg-background relative overflow-hidden">
      <div className="section-container">
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-5 md:gap-8 lg:gap-12">
          {[
            ...
            <div key={i} className="text-center p-6 md:p-8 rounded-2xl bg-card border border-border hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-5 md:mb-6">
