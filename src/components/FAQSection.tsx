...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "মোটেও না! আপনি আমাদের ভিডিও গাইডলাইন দেখে নিজেই খুব সহজে ইনস্টলেশন করতে পারবেন। প্রয়োজন হলে আমাদের অনলাইন সাপোর্ট সম্পূর্ণ ফ্রি রয়েছে। সাধারণত ৩০ মিনিটের মধ্যেই পুরো সিস্টেম চালু করা সম্ভব।",
  },
  {
  ...
  },
  {
    ...
    answer:
      "সকল ডিভাইসে ১ বছরের ওয়ারেন্টি রয়েছে। এছাড়া আমাদের কাস্টমার সাপোর্ট টিম সবসময় আপনার সেবায় প্রস্তুত। হটলাইনে কল করে বা ইমেইলে যোগাযোগ করতে পারবেন।",
  },
  {
